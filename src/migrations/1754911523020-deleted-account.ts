...
export class DeletedAccount1754911523020 implements MigrationInterface {
  name = 'DeletedAccount1754911523020';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    `);
    await queryRunner.query(
      `ALTER TYPE "public"."provider_profile_status_enum" RENAME TO "provider_profile_status_enum_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."provider_profile_status_enum" AS ENUM('new', 'accepted', 'rejected', 'blocked', 'deleted')`,
    );
    await queryRunner.query(
      `ALTER TABLE "provider" ALTER COLUMN "profile_status" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "provider" ALTER COLUMN "profile_status" TYPE "public"."provider_profile_status_enum" USING "profile_status"::"text"::"public"."provider_profile_status_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "provider" ALTER COLUMN "profile_status" SET DEFAULT 'new'`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."provider_profile_status_enum_old"`,
    );
    await queryRunner.query(`
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    `);
    await queryRunner.query(
      `CREATE TYPE "public"."provider_profile_status_enum_old" AS ENUM('new', 'accepted', 'rejected', 'blocked')`,
    );
    await queryRunner.query(
      `ALTER TABLE "provider" ALTER COLUMN "profile_status" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "provider" ALTER COLUMN "profile_status" TYPE "public"."provider_profile_status_enum_old" USING "profile_status"::"text"::"public"."provider_profile_status_enum_old"`,
    );
    await queryRunner.query(
      `ALTER TABLE "provider" ALTER COLUMN "profile_status" SET DEFAULT 'new'`,
    );
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."provider_profile_status_enum_old" RENAME TO "provider_profile_status_enum"`,
    );
    await queryRunner.query(`
        DROP VIEW IF EXISTS view_provider_list;
    `);
